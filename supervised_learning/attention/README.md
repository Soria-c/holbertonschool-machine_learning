...
×
#### Students who are done with "7\. Transformer Decoder Block"
...
×
#### Correction of "7\. Transformer Decoder Block"
...
×
#### Students who are done with "8\. Transformer Encoder"
...
×
#### Correction of "8\. Transformer Encoder"
...
* File exists
* First line contains `#!/usr/bin/env python3`
* Not allowed to import anything except `import tensorflow as tf`, `positional_encoding = __import__('4-positional_encoding').positional_encoding`, and `EncoderBlock = __import__('7-transformer_encoder_block').EncoderBlock`
* Correct output: Class attributes set properly
* Output check: call correctly implemented
* pycodestyle validation
* Everything is documented
...
×
#### Students who are done with "9\. Transformer Decoder"
...
×
#### Correction of "9\. Transformer Decoder"
...
* File exists
* First line contains `#!/usr/bin/env python3`
* Not allowed to import anything except `import tensorflow as tf`, `positional_encoding = __import__('4-positional_encoding').positional_encoding`, and `DecoderBlock = __import__('8-transformer_decoder_block').DecoderBlock`
* Correct output: Class attributes set properly
* Output check: call correctly implemented
* pycodestyle validation
* Everything is documented
...
×
#### Students who are done with "10\. Transformer Network"
...
×
#### Correction of "10\. Transformer Network"
...
* File exists
* First line contains `#!/usr/bin/env python3`
* Not allowed to import anything except `import tensorflow as tf`, `Encoder = __import__('9-transformer_encoder').Encoder` and `Decoder = __import__('10-transformer_decoder').Decoder`
* Correct output: Class attributes set properly
* Output check: call correctly implemented
* pycodestyle validation
* Everything is documented
...
[Previous project](/projects/2394)  
...
Next project: Transformer Applications

[Open the next project](/projects/2422)
