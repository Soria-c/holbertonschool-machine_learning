...
* [Hyperparameter Tuning in Practice](https://www.youtube.com/watch?v=wKkcBPp3F1Y&list=PLkDaE6sCZn6Hn0vK8co82zjQtt3T2Nkqc&index=27 "Hyperparameter Tuning in Practice")
* [Orthogonalization](https://www.youtube.com/watch?v=UEtvV1D6B3s&list=PLkDaE6sCZn6E7jZ9sN_xHwSHOdjUxUW_b&index=3 "Orthogonalization")
* [Single Number Evaluation Metric](https://www.youtube.com/watch?v=sofffBNhVSo&list=PLkDaE6sCZn6E7jZ9sN_xHwSHOdjUxUW_b&index=4 "Single Number Evaluation Metric")
* [Satisficing and Optimizing Metrics](https://www.youtube.com/watch?v=BH9mlmdXzzI&list=PLkDaE6sCZn6E7jZ9sN_xHwSHOdjUxUW_b&index=5 "Satisficing and Optimizing Metrics")
...
* [Machine learning \- Gaussian processes](https://www.youtube.com/watch?v=MfHKW5z-OOA "Machine learning - Gaussian processes")
* [Quick Start to Gaussian Process Regression](https://towardsdatascience.com/quick-start-to-gaussian-process-regression-36d838810319 "Quick Start to Gaussian Process Regression")
* [Gaussian processes](http://krasserm.github.io/2018/03/19/gaussian-processes/ "Gaussian processes")
...
* [Bayesian Optimization](http://krasserm.github.io/2018/03/21/bayesian-optimization/ "Bayesian Optimization")
...
* [A Tutorial on Bayesian Optimization](https://arxiv.org/pdf/1807.02811 "A Tutorial on Bayesian Optimization")
* [GPy documentation](https://gpy.readthedocs.io/en/latest/ "GPy documentation")
  + [GPy.kern.src](https://gpy.readthedocs.io/en/latest/GPy.kern.src.html "GPy.kern.src")
  + [GPy.plotting.gpy\_plot](https://gpy.readthedocs.io/en/latest/GPy.plotting.gpy_plot.html "GPy.plotting.gpy_plot")
* [GPyOpt documentation](https://gpyopt.readthedocs.io/en/latest/ "GPyOpt documentation")
  + [GPyOpt.methods.bayesian\_optimization](https://gpyopt.readthedocs.io/en/latest/GPyOpt.methods.html#module-GPyOpt.methods.bayesian_optimization "GPyOpt.methods.bayesian_optimization")
  + [GPyOpt.core.task.space](https://gpyopt.readthedocs.io/en/latest/GPyOpt.core.task.html#module-GPyOpt.core.task.space "GPyOpt.core.task.space")
