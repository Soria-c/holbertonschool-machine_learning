...
* [Properties of Markov Chains](https://pdf4pro.com/download/10-1-properties-of-markov-chains-governors-state-university-4c8fed.html "Properties of Markov Chains")
...
* [Markov Chains, Part 1](https://www.youtube.com/watch?v=uvYTGEZQTEs "Markov Chains, Part 1")
* [Markov Chains, Part 2](https://www.youtube.com/watch?v=jtHBfLtMq4U "Markov Chains, Part 2")
* [Markov Chains, Part 3](https://www.youtube.com/watch?v=P8DuuiINAo4 "Markov Chains, Part 3")
* [Markov Chains, Part 4](https://www.youtube.com/watch?v=31X-M4okAI0 "Markov Chains, Part 4")
* [Markov Chains, Part 5](https://www.youtube.com/watch?v=-kwnnNSGFMc "Markov Chains, Part 5")
* [Markov Chains, Part 7](https://www.youtube.com/watch?v=bTeKu7WdbT8 "Markov Chains, Part 7")
* [Markov Chains, Part 8](https://www.youtube.com/watch?v=BsOkOaB8SFk "Markov Chains, Part 8")
* [Markov Chains, Part 9](https://www.youtube.com/watch?v=qhnFHnLkrfA "Markov Chains, Part 9")
...
* [(ML 14\.1\) Markov models \- motivating examples](https://www.youtube.com/watch?v=7KGdE2AK_MQ&list=PLD0F06AA0D2E8FFBA&index=97 "(ML 14.1) Markov models - motivating examples")
* [(ML 14\.2\) Markov chains (discrete\-time) (part 1\)](https://www.youtube.com/watch?v=WUjt98HcHlk&list=PLD0F06AA0D2E8FFBA&index=98 "(ML 14.2) Markov chains (discrete-time) (part 1)")
* [(ML 14\.3\) Markov chains (discrete\-time) (part 2\)](https://www.youtube.com/watch?v=j6OUj9tleVM&list=PLD0F06AA0D2E8FFBA&index=99 "(ML 14.3) Markov chains (discrete-time) (part 2)")
* [(ML 14\.4\) Hidden Markov models (HMMs) (part 1\)](https://www.youtube.com/watch?v=TPRoLreU9lA&list=PLD0F06AA0D2E8FFBA&index=100 "(ML 14.4) Hidden Markov models (HMMs) (part 1)")
* [(ML 14\.5\) Hidden Markov models (HMMs) (part 2\)](https://www.youtube.com/watch?v=M_IIW0VYMEA&list=PLD0F06AA0D2E8FFBA&index=101 "(ML 14.5) Hidden Markov models (HMMs) (part 2)")
* [(ML 14\.6\) Forward\-Backward algorithm for HMMs](https://www.youtube.com/watch?v=7zDARfKVm7s&list=PLD0F06AA0D2E8FFBA&index=102 "(ML 14.6) Forward-Backward algorithm for HMMs")
* [(ML 14\.7\) Forward algorithm (part 1\)](https://www.youtube.com/watch?v=M7afek1nEKM&list=PLD0F06AA0D2E8FFBA&index=103 "(ML 14.7) Forward algorithm (part 1)")
* [(ML 14\.8\) Forward algorithm (part 2\)](https://www.youtube.com/watch?v=MPmrFu4jFk4&list=PLD0F06AA0D2E8FFBA&index=104 "(ML 14.8) Forward algorithm (part 2)")
* [(ML 14\.9\) Backward algorithm](https://www.youtube.com/watch?v=jwYuki9GgJo&list=PLD0F06AA0D2E8FFBA&index=105 "(ML 14.9) Backward algorithm")
* [(ML 14\.10\) Underflow and the log\-sum\-exp trick](https://www.youtube.com/watch?v=-RVM21Voo7Q&list=PLD0F06AA0D2E8FFBA&index=106 "(ML 14.10) Underflow and the log-sum-exp trick")
* [(ML 14\.11\) Viterbi algorithm (part 1\)](https://www.youtube.com/watch?v=RwwfUICZLsA&list=PLD0F06AA0D2E8FFBA&index=107 "(ML 14.11) Viterbi algorithm (part 1)")
* [(ML 14\.12\) Viterbi algorithm (part 2\)](https://www.youtube.com/watch?v=t3JIk3Jgifs&list=PLD0F06AA0D2E8FFBA&index=108 "(ML 14.12) Viterbi algorithm (part 2)")
...
![](./data/a4a616525a089952d29f.png)


![](./data/f847db61fbc52eda75d9.png)
